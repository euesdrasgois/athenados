 ...
 * $Id: tools_backupdb.lang.php 19/11/2012 18:11:00 Speeder $
 */
...
$l['download'] = "Fazer o Download";
$l['table_selection'] = "Seleção de Tabela";
$l['backup_options'] = "Opções de Backup";
$l['table_select_desc'] = "Você pode selecionar as tabelas do banco de dados em que você deseja que as ações sejam executadas. Segure CTRL para selecionar várias tabelas.";
...
$l['save_method'] = "Método de Backup";
$l['save_method_desc'] = "Selecione o método que você deseja usar para salvar o backup.";
$l['backup_directory'] = "Salvar no Sistema de Arquivos";
$l['backup_contents'] = "Tipo de Conteúdo";
