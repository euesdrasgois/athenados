...
// Last edited date : Wed, 28 Jun 2017 19:42:35 +0000
// --------------------------------------------------------------------------------

$l['task_manager'] = 'Gerenciar Tarefas';
$l['add_new_task'] = 'Adicionar Nova Tarefa';
$l['add_new_task_desc'] = 'Aqui você pode criar novas tarefas agendadas que rodarão automaticamente no fórum.';
...
$l['view_task_logs_desc'] = 'Quando uma tarefa é executada e o log estiver habilitado, quaisquer resultados e erros serão listados abaixo. Entradas mais antigas que 30 dias são automaticamente excluídas.';
$l['scheduled_tasks'] = 'Tarefas Agendadas';
$l['scheduled_tasks_desc'] = 'Aqui você pode gerenciar as tarefas que são executadas automaticamente no fórum. Para executar uma tarefa agora, clique no ícone ao lado direito do nome da tarefa.';
$l['title'] = 'Título';
...
$l['confirm_task_enable'] = '<strong>AVISO:</strong> Você está a ponto de habilitar uma tarefa que só poderia ser executada via cron. Continuar?';
$l['no_tasks'] = 'Não há tarefas no seu fórum neste momento.';
